...
export default function CategoriesBar() {
  return (
    <div className={styles.main_container}>
      ...
      <h4>The name of the photo file should be your e-mail address without ".com" ( for instance: keenregen@gmail ). You should upload the photo file via the related part below (first choose the file then click the upload button).<br /> <strong>The last day to submit your work is: 15 July 2023</strong><br /><br /></h4>
