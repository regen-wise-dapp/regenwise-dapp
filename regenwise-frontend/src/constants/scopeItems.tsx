...
export const scopeItems: ScopeItem[] = [
  ...
  },
  {
    ...
    description: `<b>Regenerative energy</b> encompasses renewable sources like solar, wind, hydro, and 
    ...
    towards a low-carbon economy.<br /><b>Regenerative building design and practices</b> prioritize 
  ...
  },
  {
    ...
    description: `<h4>Regenerative practices can also be applied to waste management systems. These involve adopting methods such as composting, recycling, and waste-to-energy technologies to minimize waste sent to landfills and promote the regeneration of valuable resources.</h4>`,
    url: '',
    image: '/scope/4a.jpg',
